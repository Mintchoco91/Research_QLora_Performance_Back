...
class VRAMLoggingCallback(TrainerCallback):
    def on_step_end(self, args, state, control, **kwargs):
        ...
        vram_used = torch.cuda.max_memory_reserved() / 1024**2
        wandb.log({"VRAM_Used_MB": vram_used, "step": state.global_step})
...
wandb.log({"VRAM_Peak_MB": vram_peak})
print(f"Peak VRAM usage: {vram_peak:.2f} MB")
